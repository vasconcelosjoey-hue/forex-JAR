...
import { Calendar, Target, Plus, ArrowUpRight, Save, Trash2, Flag, Percent, Wallet, ArrowRight, ChevronDown, ChevronUp } from 'lucide-react';
                                   ...
                                   <tr key={record.date} className="border-b border-white/5 hover:bg-[#00e676] hover:text-black transition-colors group">
                                       ...
                                       <td className="py-3 px-4 text-center">
                                           <button 
                                              ...
                                              className="text-neutral-500 hover:text-white transition-colors p-2 hover:bg-[#ff4444] rounded-none z-10 relative cursor-pointer"
                                              title="Apagar"
                                           >
